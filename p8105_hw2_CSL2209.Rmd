...
There are many zip codes not included in the ZORI data set as shown by the table `missing zips'. Some of these ZIp codes might be exlcuded from the Zillow dataset due to lack of rental activity. Zillow only has data on listings that were/are active on that platform. Areas such as the Rockaways or zip codes excluded in the Bronx may have little to no online rental activity, meaning it would be excluded from Zillow's profile. 
...
The price change was calculated by subtracting the 2020 ZORIs from the 2021 ZORIs. This means that the largest negative values would indicate the greatest price drop. In this case, 10001 had the greatest price drop.
