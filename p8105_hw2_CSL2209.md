...
| skim_variable | n_missing | complete_rate | min | max | empty | n_unique | whitespace |
|:--------------|----------:|--------------:|----:|----:|------:|---------:|-----------:|
| county        |         0 |             1 |   5 |   8 |     0 |        5 |          0 |
| county_code   |         0 |             1 |   3 |   3 |     0 |        5 |          0 |

**Variable type: factor**

| skim_variable | n_missing | complete_rate | ordered | n_unique | top_counts |
|:---|---:|---:|:---|---:|:---|
| zip_code | 0 | 1.00 | FALSE | 272 | 104: 2, 100: 1, 100: 1, 100: 1 |
| neighborhood | 141 | 0.48 | FALSE | 36 | Sou: 9, Sou: 8, Jam: 7, Nor: 7 |
...
| county_fips | 0 | 1 | 36060.25 | 22.61 | 36005 | 36061 | 36061 | 36081 | 36085 | ▂▁▂▇▆ |

There are many zip codes not included in the ZORI data set as shown by
the table \`missing zips’ Make a table that shows the 10 ZIP codes
