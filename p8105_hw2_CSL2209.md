...
missing_zips =
  zip_codes |>
  filter(!zip_code %in% zori$zip_code) 

missing_zips
```

    ## # A tibble: 273 × 6
    ##    county state_fips county_code county_fips zip_code neighborhood              
    ##    <chr>       <dbl> <chr>             <dbl> <fct>    <fct>                     
    ##  1 Bronx          36 005               36005 10451    High Bridge and Morrisania
    ##  2 Bronx          36 005               36005 10452    High Bridge and Morrisania
    ##  3 Bronx          36 005               36005 10453    Central Bronx             
    ##  4 Bronx          36 005               36005 10454    Hunts Point and Mott Haven
    ##  5 Bronx          36 005               36005 10455    Hunts Point and Mott Haven
    ##  6 Bronx          36 005               36005 10456    High Bridge and Morrisania
    ##  7 Bronx          36 005               36005 10457    Central Bronx             
    ##  8 Bronx          36 005               36005 10458    Bronx Park and Fordham    
    ##  9 Bronx          36 005               36005 10459    Hunts Point and Mott Haven
    ## 10 Bronx          36 005               36005 10460    Central Bronx             
    ## # ℹ 263 more rows

There are many zip codes not included in the ZORI data set as shown by
the table \`missing zips’. Some of these ZIp codes might be exlcuded
from the Zillow dataset due to lack of rental activity. Zillow only has
data on listings that were/are active on that platform. Areas such as
the Rockaways or zip codes excluded in the Bronx may have little to no
online rental activity, meaning it would be excluded from Zillow’s
profile.
...
price_drop =
  ...
  head(10) |>
  select(zip_code, county, neighborhood, price_change)
```

The price change was calculated by subtracting the 2020 ZORIs from the
2021 ZORIs. This means that the largest negative values would indicate
the greatest price drop. In this case, 10001 had the greatest price
drop.
